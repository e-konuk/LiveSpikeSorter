...
**We highly reccomend starting with an offline test run  →  OfflineSortingGuide.txt** 

Before taking LSS into a live experiment, you should first try sorting a recording you already have by replaying a `.ap.bin` file on SpikeGLX through a simulated probe,.

[**OfflineSortingGuide.txt**](http://OfflineSortingGuide.txt) walks through the whole process with extensive instructions for first-time machine/dependency setup
